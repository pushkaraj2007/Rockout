    ...
    <>
      ...
      <div id="outerMostDiv" className="hidden">
              ...
              <div className="flex justify-between items-center w-[100%] mt-4">
                <div className="ml-5">
                  ...
                  <div className="flex justify-center">
                    <p className="mt-3 font-bold text-green-600 text-5xl">
                      {playerScore}
                    </p>
                  </div>
                </div>
        ...
        <div className="flex flex-col items-center justify-center mt-8">
          ...
          <div className="flex">
            <button
              className="bg-gray-200 hover:bg-gray-300 text-xl font-bold py-4 px-8 rounded-md mr-4 hover:animate-pulse dark:text-black"
              disabled={disabled}
            ...
            <button
              className="bg-gray-200 hover:bg-gray-300 text-xl font-bold py-4 px-8 rounded-md mr-4 dark:text-black"
              disabled={disabled}
